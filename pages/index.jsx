...
const FooterStyle = {height:"10em",backgroundImage:"url(../static/baner.jpg)",backgroundSize:"cover",backgroundPosition:"center bottom"}

const Content = () => <div style={{height:"20em",backgroundImage:"url(../static/baner.jpg)",backgroundSize:"cover",backgroundPosition:"center top"}} />
        ...
        <div style={{padding:"0px 15px"}}>
            <div>
                <span className="justify-content-sm-center row">
                    <img src="../static/yagami.jpg" height="250px" className="rounded-circle" alt="img" style={{position:"absolute",zIndex:1,top:"10em"}} />
                </span>
            </div>
        ...
        <div style={WhiteZone} className="container">
            ...
            <div className="row">
                <span className="col-sm">
                    <img src="../static/chara.jpg" height="150px" className="img-thumbnail" alt="img"/>
                    <p>
...
const FooterContent = () => {
    return(
        <Fragment>
            ...
            <div>
                <span style={{position:"absolute",zIndex:1}}>Hello</span>
            </div>
        </Fragment>
    )
}
